...
namespace Avalonia.Controls.TreeDataGridTests
{
    public class HierarchicalTreeDataGridSelectionModelTests_Single
    {
        ...
        {
            return HierarchicalTreeDataGridSelectionModelTests_Single.GetTarget(source, true);
        }
        ...
        private static HierarchicalTreeDataGridSelectionModel<Node> GetTarget(
            HierarchicalTreeDataGridSource<Node> source,
            bool singleSelect)
        {
            var result = (HierarchicalTreeDataGridSelectionModel<Node>)source.Selection;
            result.SingleSelect = singleSelect;
            return result;
        }
