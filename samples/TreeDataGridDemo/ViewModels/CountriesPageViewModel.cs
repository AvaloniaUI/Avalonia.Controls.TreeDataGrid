        ...
        public CountriesPageViewModel()
        {
            ...
            Source = new FlatTreeDataGridSource<Country>(_data)
            {
                Columns =
                {
                    ...
                    new TextColumn<Country, int>("Population", x => x.Population, new GridLength(3, GridUnitType.Star), new()
                    {
                        IsFilterEnabled = true,
                    }),
                    new TextColumn<Country, int>("Area", x => x.Area, new GridLength(3, GridUnitType.Star), new()
                    {
                        IsFilterEnabled = true,
                    }),
